    ...
    return (
      <div className="landingdiv container" id="home">
        ...
        <div className="header top">
          Hello, I'm <span className="name">Martin</span>
        </div>
        <div className="header bot">I'm a front end developer</div>
        <div className="header icon">
          <div className="icon-container">
            <a
              href="https://github.com/martinchmui"
              target="_blank"
              rel="noreferrer"
            >
              <img
          ...
          <div className="icon-container">
            <a
              href="https://drive.google.com/file/d/15SlBts7oIjQGBtmN47KBBsolQZt48CHi/view"
              target="_blank"
              rel="noreferrer"
            >
              <img
